...
#define WSC_GPIO_FILE	"/proc/gpio"
...
#if 1// ASUS
	unsigned int    asus_ie_len;
	unsigned char   asus_ie[65];
#endif
...
#if defined(TRIBAND_WPS)
	int wlan2_wsc_disabled; /* FOR_THREE_BAND  wlan0-va0 or wlan2 */
#endif
#ifdef FOR_DUAL_BAND
	int socket2;
...
#ifdef CONFIG_RTK_DEV_AP
extern int updateWscConf(char *in, char *out, int genpin, char *wlanif_name);
#endif
