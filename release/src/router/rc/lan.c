...
#else
#if defined(MS60)
					(check_if_exist_ifnames("sta_ifnames",ifname) || check_if_exist_ifnames("sta_phy_ifnames",ifname)))
#else
...
#else
#if defined(MS60)
				(strstr(nvram_safe_get("sta_ifnames"), ifname) || strstr(nvram_safe_get("sta_phy_ifnames"), ifname)))
#else
