...
#ifdef HND_ROUTER
#if (defined(TUFAX3000_V2) && !defined(TY6201PRO) && !defined(RGMA3062)) || defined(RTAXE7800) || defined(EBG19)
			bcm53134_led_control(2);
#endif
#if (defined(TUFAX3000_V2) && !defined(TY6201PRO) && !defined(RGMA3062)) || defined(RTAXE7800) || defined(TUFAX5400_V2) || defined(RTAX5400) || defined(RTAX88U_PRO)
